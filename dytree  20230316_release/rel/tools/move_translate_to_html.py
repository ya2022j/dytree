...
if __name__ == "__main__":
    ...
    templates_path = os.path.join(os.path.join(os.path.abspath(os.path.join(os.getcwd(),"..")),"templates"),HTML_FILENAME)
    if os.path.exists(templates_path):
        os.remove(templates_path)

    read_txtfile_to_html(templates_path, TRANSLATE_FILENAME)
